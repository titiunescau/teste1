...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN:Causs\n' // Nama kamu
            + 'ORG:Lexa;\n' // Nama bot
            + 'TEL;type=CELL;type=VOICE;waid=559887053394:+55 9887053394\n' //Nomor whatsapp kamu
            + 'END:VCARD'
prefix = '.','!','*'
blocked = []
limitawal = '999999999'
...
async function starts() {
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			const ownerNumber = ["559887053394@s.whatsapp.net"] // replace this with your number
			const mod = [ownerNumber,"559887053394@s.whatsapp.net"]//ubah nomor lo
			const adminbotnumber = ["559887053394@s.whatsapp.net"]//ubah nomor lo
			const frendsowner = ["559887053394@s.whatsapp.net"]//ubah nomor lo
			const premium = ["559887053394@s.whatsapp.net","559887053394@s.whatsapp.net"] 
